...
$roleAccounts = [
    'ADMIN' => ['username' => 'doc4_admin', 'password' => 'doc4_admin_2026', 'name' => 'Doc4 Admin'],
    'PURCHASE' => ['username' => 'doc4_purchase', 'password' => 'doc4_purchase_2026', 'name' => 'Doc4 Purchase'],
    'HR' => ['username' => 'doc4_hr', 'password' => 'doc4_hr_2026', 'name' => 'Doc4 HR'],
    'SALE' => ['username' => 'doc4_sale', 'password' => 'doc4_sale_2026', 'name' => 'Doc4 Sale'],
    'ACCOUNT' => ['username' => 'doc4_account', 'password' => 'doc4_account_2026', 'name' => 'Doc4 Account'],
    'POS' => ['username' => 'doc4_pos', 'password' => 'doc4_pos_2026', 'name' => 'Doc4 POS'],
    'WAREHOUSE' => ['username' => 'doc4_warehouse', 'password' => 'doc4_warehouse_2026', 'name' => 'Doc4 Warehouse'],
    'PRODUCTION' => ['username' => 'doc4_production', 'password' => 'doc4_production_2026', 'name' => 'Doc4 Production'],
    'AUDIT' => ['username' => 'doc4_audit', 'password' => 'doc4_audit_2026', 'name' => 'Doc4 Audit'],
];
...
$outputPath = __DIR__ . '/../docs/doc4_role_accounts.json';
file_put_contents($outputPath, json_encode([
    'generated_at' => date('c'),
    'source' => 'setup_doc4_role_users.php',
    'roles' => $results,
